...
Pi provides the agent loop, tools, sessions, and 15+ LLM providers. Detrix provides
governance gates, scoring, training, improvement, and domain packs — all via pi's extension
system. Distribution: `pi install npm:@detrix/governance`. Skills generated by MetaClaw
